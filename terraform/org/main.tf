...
# IAM binding changes for project pam-dp-maf
resource "google_project_iam_member_remove" "remove_network_admin_for_environmentgate_sa" {
  project = "pam-dp-maf"
  role    = "roles/compute.networkAdmin"
  member  = "serviceAccount:environmentgate-admin@pam-dp-maf.iam.gserviceaccount.com"
}

resource "google_project_iam_member" "add_regional_endpoint_viewer_for_environmentgate_sa" {
  project = "pam-dp-maf"
