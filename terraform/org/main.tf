...
# Remove 'roles/owner' for 'serviceAccount:cloud-console-test-provisioner@system.gserviceaccount.com' from project 'p6n745533380-hyw6jnnp-251025-b'
...
# Remove 'roles/billing.projectManager' for 'user:p6n.transferstation@gmail.com' from project 'p6n745533380-hyw6jnnp-251025-b'
