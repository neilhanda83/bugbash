...
# Remove owner role for serviceAccount:cloud-console-test-provisioner@system.gserviceaccount.com from project p6n745533380-hyw6jnnp-251025-b
...
# Remove billing.projectManager role for user:p6n.transferstation@gmail.com from project p6n745533380-hyw6jnnp-251025-b
resource "google_project_iam_member_remove" "remove_billing_manager_p6n_transferstation" {
  project = "p6n745533380-hyw6jnnp-251025-b"
