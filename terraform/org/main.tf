...
resource "google_project_iam_member_remove" "remove_cloudasset_owner_for_security_sa" {
...
resource "google_project_iam_member" "add_cloud_assets_feeds_for_security_sa" {
  project = "e2e-rego-posture-staging"
...
resource "google_project_iam_member_remove" "remove_custom_modules_viewer_for_user" {
  project = "e2e-rego-posture-staging"
...
resource "google_project_iam_member" "add_sha_custom_modules_viewer_for_user" {
  project = "e2e-rego-posture-staging"
