...
# IAM bindings for project sdw-non-conf-296463-fbad and group:slz-blr@google.com

# Add roles/bigquery.dataViewer for group:slz-blr@google.com
resource "google_project_iam_member" "bigquery_data_viewer_slz_blr" {
  project = "sdw-non-conf-296463-fbad"
  role    = "roles/bigquery.dataViewer"
  member  = "group:slz-blr@google.com"
}

# Add roles/bigquery.jobUser for group:slz-blr@google.com
resource "google_project_iam_member" "bigquery_job_user_slz_blr" {
  project = "sdw-non-conf-296463-fbad"
...
resource "google_project_iam_member_remove" "bigquery_data_editor_slz_blr" {
  project = "sdw-non-conf-296463-fbad"
...
resource "google_project_iam_member_remove" "bigquery_user_slz_blr" {
  project = "sdw-non-conf-296463-fbad"
