...
# Remove roles/dataflow.developer for group:slz-blr@google.com (as both ADD and REMOVE were requested, REMOVE takes precedence)
...
resource "google_project_iam_member" "add_storage_insights_collector_mansie" {
  project = "sdw-data-ing-e7b15f-dbf3"
