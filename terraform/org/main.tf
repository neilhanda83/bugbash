...
# IAM bindings for project sdw-non-conf-269735-2918 and member group:slz-blr@google.com

# Remove roles/bigquery.dataEditor for group:slz-blr@google.com
resource "google_project_iam_member_remove" "remove_bigquery_dataeditor_for_slz_blr_group" {
...
resource "google_project_iam_member" "add_bigquery_dataviewer_for_slz_blr_group" {
  project = "sdw-non-conf-269735-2918"
...
resource "google_project_iam_member" "add_bigquery_jobuser_for_slz_blr_group" {
  project = "sdw-non-conf-269735-2918"
