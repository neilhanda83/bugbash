...
# Add IAM member for 'roles/networkconnectivity.regionalEndpointViewer' to project 'pam-deny-maf'
...
# Remove IAM member for 'roles/compute.networkAdmin' from project 'pam-deny-maf'
