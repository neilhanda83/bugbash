...
# Add IAM member for roles/bigquery.dataViewer for project sdw-non-conf-ce107b-38ca
resource "google_project_iam_member" "add_bigquery_dataviewer_slz_blr" {
  project = "sdw-non-conf-ce107b-38ca"
  role    = "roles/bigquery.dataViewer"
  member  = "group:slz-blr@google.com"
}

# Add IAM member for roles/bigquery.jobUser for project sdw-non-conf-ce107b-38ca
...
# Remove IAM member for roles/bigquery.dataEditor for project sdw-non-conf-ce107b-38ca
...
# Remove IAM member for roles/bigquery.user for project sdw-non-conf-ce107b-38ca
