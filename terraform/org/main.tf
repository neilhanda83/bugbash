...
# IAM Binding updates for project shishir-aiposturegen-test
# Action: REMOVE roles/resourcemanager.organizationAdmin for user:krgaurv@google.com
...
# Action: ADD organizations/9454078371/roles/CustomRole262 for user:krgaurv@google.com
