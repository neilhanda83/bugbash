...
# Remove the serviceUsageConsumer role for the specified service account from the 'debug-egress' project
resource "google_project_iam_member_remove" "remove_service_usage_consumer_debug_egress" {
