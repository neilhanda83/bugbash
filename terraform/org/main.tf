...
# Remove IAM binding for roles/servicemanagement.admin for user:adeepanshu@google.com
...
# Remove IAM binding for roles/serviceusage.serviceUsageConsumer for user:adeepanshu@google.com
