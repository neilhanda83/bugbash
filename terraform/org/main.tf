...
# Data source for the target project 'pam-dp-maf'
data "google_project" "target_project_pam_dp_maf" {
  project_id = "pam-dp-maf"
}
...
resource "google_project_iam_member_remove" "remove_network_admin_for_environmentgate_admin" {
  project = data.google_project.target_project_pam_dp_maf.project_id
