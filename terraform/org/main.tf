...
# Remove the 'roles/owner' role for 'serviceAccount:cloud-console-test-provisioner@system.gserviceaccount.com'
...
# Remove the 'roles/billing.projectManager' role for 'user:p6n.transferstation@gmail.com'
