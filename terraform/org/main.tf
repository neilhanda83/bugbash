...
# Remove serviceAccountTokenCreator role for user:singhakan@google.com from project manualiamregotesting
resource "google_project_iam_member_remove" "remove_service_account_token_creator_for_singhakan" {
