...
# Remove the 'roles/serviceusage.serviceUsageConsumer' role for 'serviceAccount:overwatch-playbooks@akieras-ip.iam.gserviceaccount.com' on project 'debug-egress'
