...
# Remove roles
resource "google_project_iam_member_remove" "remove_cloudbuild_builds_editor_slz_blr" {
...
# Add roles
resource "google_project_iam_member" "add_cloudbuild_builds_viewer_slz_blr" {
  project = "sdw-data-ing-3ec740-0ed8"
