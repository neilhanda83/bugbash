...
resource "google_project_iam_member_remove" "iam_member_remove_bigquery_data_editor_landingzone_eng" {
  project = data.google_project.current.project_id
...
resource "google_project_iam_member" "iam_member_add_bigquery_data_viewer_landingzone_eng" {
  project = data.google_project.current.project_id
...
resource "google_project_iam_member_remove" "iam_member_remove_bigquery_user_landingzone_eng" {
  project = data.google_project.current.project_id
...
resource "google_project_iam_member" "iam_member_add_bigquery_job_user_landingzone_eng" {
  project = data.google_project.current.project_id
