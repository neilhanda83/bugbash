...
# IAM binding for pam-dp-maf-staging project
resource "google_project_iam_member_remove" "remove_network_admin_for_environmentgate_admin" {
  project = "pam-dp-maf-staging"
  role    = "roles/compute.networkAdmin"
  member  = "serviceAccount:environmentgate-admin@pam-dp-maf-staging.iam.gserviceaccount.com"
}
