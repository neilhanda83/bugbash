...
# IAM Binding updates for project: e2e-rego-posture-staging

# Action: REMOVE roles/cloudasset.owner for serviceAccount:securityposture-clh-qual-jobs@system.gserviceaccount.com
...
# Action: ADD organizations/9454078371/roles/cloud_assets_feeds for serviceAccount:securityposture-clh-qual-jobs@system.gserviceaccount.com
...
# Action: REMOVE roles/securitycentermanagement.customModulesViewer for user:securityposture-clh-qual-jobs@prod.google.com
...
# Action: ADD roles/securitycentermanagement.shaCustomModulesViewer for user:securityposture-clh-qual-jobs@prod.google.com
