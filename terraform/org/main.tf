...
# IAM binding removals for serviceAccount:dwsalabels@gfelipesbpsa.iam.gserviceaccount.com on project ci-sdw-ext-flx-30b0ce-3a9f
resource "google_project_iam_member_remove" "remove_iam_dwsalabels_artifactregistry_admin" {
  project = "ci-sdw-ext-flx-30b0ce-3a9f"
  role    = "roles/artifactregistry.admin"
  member  = "serviceAccount:dwsalabels@gfelipesbpsa.iam.gserviceaccount.com"
}

resource "google_project_iam_member_remove" "remove_iam_dwsalabels_browser" {
  project = "ci-sdw-ext-flx-30b0ce-3a9f"
  role    = "roles/browser"
  member  = "serviceAccount:dwsalabels@gfelipesbpsa.iam.gserviceaccount.com"
}

resource "google_project_iam_member_remove" "remove_iam_dwsalabels_cloudbuild_builds_editor" {
  project = "ci-sdw-ext-flx-30b0ce-3a9f"
  role    = "roles/cloudbuild.builds.editor"
  member  = "serviceAccount:dwsalabels@gfelipesbpsa.iam.gserviceaccount.com"
}

resource "google_project_iam_member_remove" "remove_iam_dwsalabels_storage_admin" {
  project = "ci-sdw-ext-flx-30b0ce-3a9f"
  role    = "roles/storage.admin"
  member  = "serviceAccount:dwsalabels@gfelipesbpsa.iam.gserviceaccount.com"
}

resource "google_project_iam_member_remove" "remove_iam_dwsalabels_iam_service_account_creator" {
  project = "ci-sdw-ext-flx-30b0ce-3a9f"
  role    = "roles/iam.serviceAccountCreator"
  member  = "serviceAccount:dwsalabels@gfelipesbpsa.iam.gserviceaccount.com"
}

resource "google_project_iam_member_remove" "remove_iam_dwsalabels_iam_service_account_deleter" {
  project = "ci-sdw-ext-flx-30b0ce-3a9f"
