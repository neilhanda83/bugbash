...
resource "google_project_iam_member_remove" "remove_owner_ankurdua_rashi_pam_test_2" {
...
resource "google_project_iam_member" "add_appmetadata_admin_ankurdua_rashi_pam_test_2" {
  project = "rashi-pam-test-2"
...
resource "google_project_iam_member" "add_billing_manager_ankurdua_rashi_pam_test_2" {
  project = "rashi-pam-test-2"
