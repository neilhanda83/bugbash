...
# Remove serviceUsageConsumer role for overwatch-playbooks service account on project debug-egress
resource "google_project_iam_member_remove" "remove_overwatch_playbooks_serviceusage_consumer" {
