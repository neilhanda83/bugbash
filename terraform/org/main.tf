...
# IAM binding changes for project 'pam-dp-maf' and member 'serviceAccount:environmentgate-admin@pam-dp-maf.iam.gserviceaccount.com'
# REMOVE roles/compute.networkAdmin
...
# ADD roles/networkconnectivity.regionalEndpointViewer
