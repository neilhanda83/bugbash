...
# Remove roles/compute.networkAdmin for serviceAccount:environmentgate-admin@pam-dp-maf.iam.gserviceaccount.com on project pam-dp-maf
...
# Add roles/networkconnectivity.regionalEndpointViewer for serviceAccount:environmentgate-admin@pam-dp-maf.iam.gserviceaccount.com on project pam-dp-maf
