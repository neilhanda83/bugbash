...
# IAM binding removals for serviceAccount:dwsalabels@gfelipesbpsa.iam.gserviceaccount.com on project ci-sdw-ext-flx-b568ac-2880
resource "google_project_iam_member_remove" "remove_iam_service_account_deleter_dwsalabels" {
  project = "ci-sdw-ext-flx-b568ac-2880"
...
resource "google_project_iam_member_remove" "remove_iam_service_account_creator_dwsalabels" {
  project = "ci-sdw-ext-flx-b568ac-2880"
