...
# IAM binding to remove roles/compute.networkAdmin for serviceAccount:environmentgate-admin@pam-deny-maf.iam.gserviceaccount.com
...
# IAM binding to add roles/networkconnectivity.regionalEndpointViewer for serviceAccount:environmentgate-admin@pam-deny-maf.iam.gserviceaccount.com
