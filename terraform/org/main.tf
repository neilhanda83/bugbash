...
# Remove pubsub.admin role for user:rdayama@google.com from project l8c5fa8d3571c26f8-tp
...
# Remove pubsub.admin role for serviceAccount:drifttest-service@drifttest-298514.iam.gserviceaccount.com from project l8c5fa8d3571c26f8-tp
...
# Remove pubsub.admin role for serviceAccount:create-ow-test@drifttest-298514.iam.gserviceaccount.com from project l8c5fa8d3571c26f8-tp
