...
# Data source for the project where new IAM bindings are to be applied
data "google_project" "sdw_non_conf_project" {
  project_id = "sdw-non-conf-269735-2918"
}
...
resource "google_project_iam_member_remove" "remove_bigquery_dataeditor_slz_blr" {
  project = data.google_project.sdw_non_conf_project.project_id
