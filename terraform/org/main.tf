...
resource "google_project_iam_member_remove" "remove_viewer_for_gkmr" {
  project = data.google_project.current.project_id
  role    = "roles/viewer"
...
resource "google_project_iam_member" "add_recommender_project_util_viewer_for_gkmr" {
  project = data.google_project.current.project_id
...
resource "google_project_iam_member" "add_resourcemanager_tag_viewer_for_gkmr" {
  project = data.google_project.current.project_id
